...
export default function Footer() {
  return (
    <footer className="w-full border-t border-cyan-900/30 bg-[#06070a] py-8 text-xs text-cyan-500/70">
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="flex flex-col items-center gap-2 text-center md:items-start md:text-left">
            ...
            <p className="flex items-center gap-1.5 text-cyan-500/80">
              ...
              Zero-Knowledge Vault: Keys encrypted via AES-256-GCM locally in browser memory.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-3 md:items-end">
            <div className="flex items-center gap-4 font-medium">
              <a
                href="https://github.com/Rihan-R10/metage"
                target="_blank"
                rel="noreferrer"
            ...
            <p className="text-cyan-600">
              © 2026 Metage. MIT License. Built for AI developers.
            </p>
          </div>
